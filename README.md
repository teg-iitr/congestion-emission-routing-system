...
* Clone the repository using the following command on your console/command prompt: git clone https://github.com/teg-iitr/gh_configured_router.git in the location of your choice
